...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		if($.browser.msie)
		{
			if(settings.cssMode == "2"){
				var css=document.createElement("link");
				css.rel="stylesheet";
				css.type="text/css";
				css.href=themedir+"themes/"+settings.theme+"/style/styleMode2.css";
		...
		else
		{
			if(settings.cssMode == "2"){
				...
				var styCss = "@import url('"+themedir+"themes/"+settings.theme+"/style/styleMode2.css');";
...
//			if (thefirstid && initConfig.errorFocus) {$("#" + thefirstid).focus();}
	...
	regexValid : function(returnObj)
	{
		...
		else 
		{
			...
			setting.isValid = false;
			if((typeof regexArray)=="string") regexArray = regexArray.split(",");
